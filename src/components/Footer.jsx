...
function Footer() {
  ...
  return (
    <footer>
      {/* CTA Section */}
      <div id="cta-section" className='mt-12 pt-14 border-b border-t border-gray-300 pb-8'>
        <h1 className='text-5xl md:text-7xl md:w-4xl uppercase'>
          Let's craft your project together
        </h1>
        <a 
          href="/contact" 
          className='mt-8 text-xl md:text-3xl inline-block underline transition-colors'
        >
          Contact us
        </a>
      </div>
      ...
      >
        ...
        {/* Col 3 - Main Navigation (Fixed - no layout shift) */}
        <div id="col-3" className='text-end md:w-1/3'>
          <ul>
            <li className='text-5xl uppercase md:text-7xl cursor-pointer opacity-80 hover:opacity-100 transition-opacity'>
              Works
            </li>
            <li className='text-5xl uppercase md:text-7xl cursor-pointer opacity-80 hover:opacity-100 transition-opacity'>
              About
